<template>
    <form class="w-1/2 h-1/2 bg-white rounded-md drop-shadow-lg p-8 flex flex-col items-center gap-3" @submit.prevent="">
        ...
        <div class="w-3/4 flex flex-col gap-2">
            ...
            <input type="text" placeholder="email" class="input input-bordered input-info w-full" id="email"/>
        </div>
        <div class="w-3/4 flex flex-col gap-2">
            <label for="password" class="text-lg text-blue-950 cursor-pointer">Password</label>
            <input type="password" placeholder="password" class="input input-bordered input-info w-full" id="password"/>
        </div>
